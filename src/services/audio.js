...
const SOUND_PREFERENCE_KEY = "gamecenter.soundEnabled.v1";
const EFFECTS_VOLUME_KEY = "gamecenter.effectsVolume.v1";
const MUSIC_VOLUME_KEY = "gamecenter.musicVolume.v1";
const LEGACY_KEYS = {
  sound: "gamecenter.legacy.soundEnabled.v1",
  effects: "gamecenter.legacy.effectsVolume.v1",
  music: "gamecenter.legacy.musicVolume.v1"
};
